...
<body>
    <?php
    echo '<input type="hidden" id="this_user" value="'.$id.'">';
    ?>
    <?php 
    ...
    <div id="page-wrapper">
        ...
        <section id="wrapper">
            <header>
                <div class="inner">
                    <h2>Settings</h2>
                    <p style="text-transform: none; color:white;">Manage a user's role, profile picture, snippets, username and password.</p>
                </div>
            </header>
            ...
            <div class="wrapper">
                <div class="inner">
                    ...
                    <h3 style="font-family:Raleway;font-weight:bold;color:white;text-align:left;font-size:16px;"class="major">Edit user's role</h3>
                    <div class="12u$">
													<div style="text-align:left; padding:15px; font-size:14px;"><label for="demo-category" style="text-align:left;">Choose a suitable role for the user</label></div>
													<div style="font-family:'Raleway'; font-weight:bold; padding-bottom:25px;"class="select-wrapper">
														<select name="demo-category" id="role-select">
															<option value="2">Admin (admin privileges)</option>
															<option value="1">User (can view and edit)</option>
															<option value="0">Viewer (can view but not edit)</option>
														</select>
													</div>
					</div>
                    <div class="12u$">
                        <ul style="text-align:left;padding:15px; "class="actions">
                            <li><input type="button" onclick="roleAjax();" value="Change role" class="special req" /></li>
                        </ul>
                    </div>


					<h3 style="font-family:Raleway;font-weight:bold;color:white;text-align:left;font-size:16px;"class="major">Edit user's profile picture</h3>
					...
					<h3 style="font-family:Raleway;font-weight:bold;color:white;text-align:left;font-size:16px;"id="edit_snippet"class="major">Edit user's snippets</h3>
			...
			?>
                    ...
                    <h3 style="font-family:Raleway;font-weight:bold;color:white;text-align:left;font-size:16px;"class="major">Change user's username</h3>
						<form>
					...
					<h3  style="font-family:Raleway;font-weight:bold;color:white;text-align:left;font-size:16px;"class="major">Change user's password</h3>
						<form>
							<div class="row uniform">
								<div  style="text-align:left;font-size:14px;" class="6u 12u$(xsmall)">
                    ...
                    <h3  style="font-family:Raleway;font-weight:bold;color:white;text-align:left;font-size:16px;"class="major">Delete this account</h3>

                    <div class="12u$">
                                    <ul style="text-align:left;" class="actions">
                                        <?php
                                        if($_SESSION['role'] == 3)
                                        echo '<li><input type="button" onclick="del('.$id.');'.'" value="Delete account" class="special req" /></li>';
                                        ?>
                                    </ul>
                                </div>
	        	...
	        	<div class="modal-dialog">
	        		<div class="modal-content">
	        			...
	        			<div class="modal-header">
	        				...
	        				<p>Add a link for user's photo</p>
	        			</div>
...
<div class="modal fade" id="modal-editsnippet" tabindex="-1" role="dialog" aria-labelledby="modal-register-label" aria-hidden="true">
    ...
    <script type="text/javascript">
    	...
    	function editAJAX(){
    		...
    		var priv = 0;
            var id = document.getElementById('this_user').value;
    		...
    		$.ajax({
                ...
                data: {csrf : csrf, snippet_id : snippet_id, title : title, pic_link : pic_link, text : text, priv : priv, id : id},
    	...
    	function picAjax(){
            ...
            $.ajax({
                ...
                data: {csrf : csrf, link : link, id : id},
                success: function(data){
                    if(data!="OK")
                    {
                        swal({
    	...
    	function passwordAjax(){
            ...
            $.ajax({
                ...
                data: {csrf : csrf, old_psswd : old_psswd, new_psswd : new_psswd, id : id},
                success: function(data){
                    if(data!="OK")
                    {
        ...
        function roleAjax(){
            var r = confirm("Are you sure you want to change the role?");
            var csrf = document.getElementById('csrf').value;
            if (r == true) {
                ...
                $.ajax({
                type: 'POST',
                url: 'php/change_role.php',
                data: {csrf : csrf, role : role, id : id},
                success: function(data){
                    if(data!="OK")
                    {
                        swal({
    	...
    	function usernameAjax(){
            ...
            $.ajax({
                ...
                data: {csrf : csrf, username : username, id : id},
                success: function(data){
                    if(data!="OK")
                    {
                        swal({
    	...
    	function deleteSnippet(id){
            ...
            if (r == true) {
    			$.ajax({
                	...
                	data: {csrf : csrf, snippet_id : id, id : document.getElementById('this_user').value},
                	success: function(data){
                    	if(data!="OK")
                    	{
                        	swal({
